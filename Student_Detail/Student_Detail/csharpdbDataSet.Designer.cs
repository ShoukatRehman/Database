...
namespace Student_Detail {
    ...
    public partial class csharpdbDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_studentDataTable : global::System.Data.TypedTableBase<tbl_studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbl_studentRow Addtbl_studentRow(string RegistrationID, string Name, string FatherName, string Mobile, int RNo, string Address, string Email) {
            ...
            private void InitClass() {
                ...
                this.columnRegistrationID.MaxLength = 25;
...
namespace Student_Detail.csharpdbDataSetTableAdapters {
    ...
    public partial class tbl_studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_student] ([RegistrationID], [Name], [FatherName], [Mobile], [RNo], [Address], [Email]) VALUES (@RegistrationID, @Name, @FatherName, @Mobile, @RNo, @Address, @Email);
SELECT RegistrationID, Name, FatherName, Mobile, RNo, Address, Email FROM tbl_student WHERE (RegistrationID = @RegistrationID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_student] SET [RegistrationID] = @RegistrationID, [Name] = @Name, [FatherName] = @FatherName, [Mobile] = @Mobile, [RNo] = @RNo, [Address] = @Address, [Email] = @Email WHERE (([RegistrationID] = @Original_RegistrationID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_FatherName = 1 AND [FatherName] IS NULL) OR ([FatherName] = @Original_FatherName)) AND ((@IsNull_Mobile = 1 AND [Mobile] IS NULL) OR ([Mobile] = @Original_Mobile)) AND ((@IsNull_RNo = 1 AND [RNo] IS NULL) OR ([RNo] = @Original_RNo)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT RegistrationID, Name, FatherName, Mobile, RNo, Address, Email FROM tbl_student WHERE (RegistrationID = @RegistrationID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Student_Detail.Properties.Settings.Default.csharpdbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT RegistrationID, Name, FatherName, Mobile, RNo, Address, Email FROM dbo.tbl" +
                "_student";
        ...
        public virtual int Fill(csharpdbDataSet.tbl_studentDataTable dataTable) {
        ...
        public virtual csharpdbDataSet.tbl_studentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            csharpdbDataSet.tbl_studentDataTable dataTable = new csharpdbDataSet.tbl_studentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(csharpdbDataSet.tbl_studentDataTable dataTable) {
        ...
        public virtual int Insert(string RegistrationID, string Name, string FatherName, string Mobile, global::System.Nullable<int> RNo, string Address, string Email) {
        ...
        public virtual int Update(string RegistrationID, string Name, string FatherName, string Mobile, global::System.Nullable<int> RNo, string Address, string Email, string Original_RegistrationID, string Original_Name, string Original_FatherName, string Original_Mobile, global::System.Nullable<int> Original_RNo, string Original_Email) {
            if ((RegistrationID == null)) {
                throw new global::System.ArgumentNullException("RegistrationID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string FatherName, string Mobile, global::System.Nullable<int> RNo, string Address, string Email, string Original_RegistrationID, string Original_Name, string Original_FatherName, string Original_Mobile, global::System.Nullable<int> Original_RNo, string Original_Email) {
            return this.Update(Original_RegistrationID, Name, FatherName, Mobile, RNo, Address, Email, Original_RegistrationID, Original_Name, Original_FatherName, Original_Mobile, Original_RNo, Original_Email);
        }
    }
